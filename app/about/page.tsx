  ...
  return (
    <>
      ...
      <section className="grid md:grid-cols-2">
        <div className="border-b border-white/10 px-6 py-16 md:border-b-0 md:border-r md:px-12 md:py-20">
          <p className="kicker">Mission</p>
          <p className="display mt-5 max-w-xl text-3xl md:text-4xl">{studio.mission}</p>
        </div>
        <div className="px-6 py-16 md:px-12 md:py-20">
          <p className="kicker">Vision</p>
          <p className="display mt-5 max-w-xl text-3xl md:text-4xl">{studio.vision}</p>
        </div>
      </section>
      ...
      <section className="bg-paper px-6 py-20 text-ink md:px-12 md:py-24">
        <div className="mx-auto max-w-5xl">
          ...
          <h2 className="display mt-5 text-4xl md:text-5xl">How we work.</h2>
          <ul className="mt-10 divide-y divide-ink/10 border-y border-ink/10">
            {values.map((value) => (
              <li key={value.title} className="grid gap-6 py-8 md:grid-cols-[220px_1fr] md:items-center">
      ...
      <section className="px-6 py-20 md:px-12 md:py-24">
        <div className="mx-auto max-w-5xl">
          ...
          <h2 className="display mt-5 text-4xl md:text-5xl">What we are building toward.</h2>
          <ol className="mt-10 space-y-5">
            {goals.map((goal, i) => (
              <li key={goal} className="rounded-[28px] border border-white/10 bg-white/[0.03] p-7 md:flex md:gap-10">
                <span className="font-mono text-gold">{String(i + 1).padStart(2, "0")}</span>
                <p className="mt-2 text-lg md:mt-0 md:text-xl">{goal}</p>
              </li>
            ))}
          </ol>
          <div className="mt-10">
