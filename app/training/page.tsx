  ...
  return (
    <>
      ...
      <section className="grid md:grid-cols-2">
        <article className="border-b border-white/10 px-6 py-20 md:border-b-0 md:border-r md:px-12">
          <span className="grid h-11 w-11 place-items-center rounded-full border border-gold/30 text-gold">
            <Icon name="users" size={18} />
          </span>
          <p className="mt-8 font-mono text-[11px] text-gold">01</p>
          <h2 className="display mt-3 text-4xl">Mentorship</h2>
        ...
        <article className="px-6 py-20 md:px-12">
          ...
          <p className="mt-8 font-mono text-[11px] text-gold">02</p>
          <h2 className="display mt-3 text-4xl">Workshops</h2>
          <p className="mt-6 max-w-md text-white/70">
