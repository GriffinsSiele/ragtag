...
export default function ServicesPage() {
  return (
    <>
      ...
      <section className="bg-paper px-6 py-20 text-ink md:px-12">
      ...
      {services.map((service, i) => (
        <section key={service.slug} className={`grid min-h-[70vh] md:grid-cols-2 ${i % 2 === 1 ? "md:[&>div:first-child]:order-2" : ""}`}>
          ...
          <div className="flex flex-col justify-center px-6 py-16 md:px-14">
            ...
            <p className="mt-8 font-mono text-[11px] text-gold">0{i + 1}</p>
            <h2 className="display mt-3 text-4xl md:text-5xl">{service.title}</h2>
            <p className="mt-6 max-w-md text-white/70">{service.summary}</p>
      ...
      <section className="px-6 py-24 text-center">
        ...
        <h2 className="display mx-auto mt-4 max-w-2xl text-4xl md:text-5xl">Let us help you bring your vision to life.</h2>
        <div className="mt-10">
