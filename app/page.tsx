...
export default function HomePage() {
  return (
    <>
      ...
      <section className="bg-paper px-6 py-28 text-ink md:px-12">
        <Reveal className="mx-auto max-w-4xl text-center">
          <p className="kicker">The studio</p>
          <h2 className="display mx-auto mt-6 max-w-3xl text-4xl md:text-6xl">
            High-end film and sound, told with cultural precision.
          </h2>
          <p className="mx-auto mt-8 max-w-2xl text-base leading-relaxed text-ink/70 md:text-lg">
            {studio.blurb}
          </p>
        </Reveal>
      </section>
      ...
      <section className="px-6 py-24 md:px-12">
        <div className="mx-auto max-w-6xl">
          <Reveal>
            ...
            <h2 className="display mt-4 max-w-xl text-4xl md:text-5xl">A full suite, any scale.</h2>
          </Reveal>
          <div className="mt-14 grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            {services.map((service, i) => (
              <Reveal key={service.slug} delay={(Math.min(i, 3) || 0) as 0 | 1 | 2 | 3}>
                <Link
                  href="/services"
                  className="card-lux block rounded-[28px] border border-white/10 bg-white/[0.03] p-8"
                >
                  ...
                  <h3 className="mt-8 text-2xl tracking-tight">{service.title}</h3>
            ...
            <Reveal delay={3}>
              ...
              >
                ...
                <h3 className="mt-8 text-2xl tracking-tight">Mentorship</h3>
      ...
      <section className="relative overflow-hidden py-32">
        ...
        <div className="relative mx-auto max-w-4xl px-6 text-center">
          <Reveal>
            ...
            <p className="display mt-8 text-3xl leading-tight md:text-5xl">{studio.mission}</p>
          </Reveal>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-6xl">
          <div className="flex flex-col justify-between gap-6 md:flex-row md:items-end">
            <div>
              ...
              <h2 className="display mt-4 text-4xl md:text-5xl">A slate in motion.</h2>
            </div>
      ...
      <section className="bg-paper px-6 py-24 text-ink md:px-12">
        <div className="mx-auto max-w-6xl">
          ...
          <h2 className="display mt-4 max-w-xl text-4xl md:text-5xl">Built for impact, not volume.</h2>
          <ol className="mt-14 divide-y divide-ink/10 border-y border-ink/10">
            {goals.map((goal, i) => (
              <li key={goal} className="grid gap-4 py-8 md:grid-cols-[120px_1fr] md:items-start">
      ...
      <section className="relative overflow-hidden py-28">
        ...
        <div className="relative mx-auto max-w-3xl px-6 text-center">
          ...
          <h2 className="display mt-6 text-4xl md:text-6xl">Bring your vision to life.</h2>
